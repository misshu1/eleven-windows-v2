...
const PrivacyApp = () => {
    return (
        <FolderApp appId={10} marginLeft={170} marginTop={120}>
            <Container>
                <p>
                    Aperture Tech Labs S.R.L (“Aperture Tech Labs” or “we”) has
                    established this privacy policy to explain to you how your
                    information is collected, used, and disclosed on its website
                    elevenwindows.dev (the “Site”).
                </p>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        automatically when you access our Site using cookies,
                        log files.
                    </li>
                    <li>
                        <strong>Disclosure for a business purpose:</strong>{' '}
                        shared with our processor Shopify, Stripe.
                    </li>
                </ul>
                <p>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        and provide you with invoices and/or order
                    ...
                    <li>
                        <strong>Source of collection:</strong> collected from
                        you.
                    </li>
                    <li>
                        <strong>Disclosure for a business purpose:</strong>{' '}
                ...
                <ul>
                    ...
                    <li>
                        <strong>Disclosure for a business purpose:</strong> 
                        <span>shared with our processor Shopify, Stripe.</span>
                    </li>
                </ul>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        advertising partners, and in some cases through the use
                        of cookies or other similar technologies (which you may
                ...
                <p>
                    We do not engage in fully automated decision-making that has
                ...
                <p>
                    ...
                    contact form at{' '}
                    <a
                        href='https://elevenwindows.dev/contact'
                        title='https://elevenwindows.dev/contact'
                    >
                        https://elevenwindows.dev/contact
                    </a>
                    <i>.</i>
                </p>
                <p>
                ...
                <p>
                    ...
                    please contact us by e-mail at nedelusandrei@gmail.com or
